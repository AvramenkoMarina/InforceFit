...
const items: Item[] = [
  {
    id: "01",
    title: "Сфотографуйте їжу",
    description:
      "Наведіть камеру на страву, додаток одразу розпізнає її та покаже калорії й макроелементи.  Сфотографуйте — це вже початок.",
    color: "bg-purple-500",
  },
  {
    id: "02",
  ...
  },
  {
    ...
    description:
      "Якщо вам зручніше шукати вручну, є зрозумілий пошук у базі з понад 20 000 українських страв. Усе, до чого ви звикли: борщ, деруни, шаурма, бабусина запіканка.",
    color: "bg-yellow-500",
  },
];
